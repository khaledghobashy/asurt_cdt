...
jac_df=pd.DataFrame([4 *[None]],columns=['rbs_connecting_rod', 'rbs_crank', 'rbs_ground', 'rbs_slider'],index=['jcs_A_sph', 'jcs_B_uni', 'jcs_C_trans', 'jcs_O_rev', 'rbs_connecting_rod', 'rbs_crank', 'rbs_ground', 'rbs_slider', 'act'])
...
eq_s=pd.Series([9 *[None]],index=['jcs_A_sph', 'jcs_B_uni', 'jcs_C_trans', 'jcs_O_rev', 'rbs_connecting_rod', 'rbs_crank', 'rbs_ground', 'rbs_slider', 'act'])
...
vel_rhs_s=pd.Series([9 *[None]],index=['jcs_A_sph', 'jcs_B_uni', 'jcs_C_trans', 'jcs_O_rev', 'rbs_connecting_rod', 'rbs_crank', 'rbs_ground', 'rbs_slider', 'act'])
def vel_rhs(actuators): 
	 vrhs=np.zeros((27,1))
	 vrhs=np.concatenate([vrhs,actuators['act'].vel_rhs()]) 
	 return vrhs 
acc_rhs_s=pd.Series([9 *[None]],index=['jcs_A_sph', 'jcs_B_uni', 'jcs_C_trans', 'jcs_O_rev', 'rbs_connecting_rod', 'rbs_crank', 'rbs_ground', 'rbs_slider', 'act'])
