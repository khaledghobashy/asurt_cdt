...
jac_df=pd.DataFrame([4 *[None]],columns=['rbs_connecting', 'rbs_crank', 'rbs_ground', 'rbs_slider'],index=['jcs_A_sph', 'jcs_B_uni', 'jcs_C_trans', 'jcs_O_rev', 'rbs_connecting', 'rbs_crank', 'rbs_ground', 'rbs_slider'])
...
eq_s=pd.Series([8 *[None]],index=['jcs_A_sph', 'jcs_B_uni', 'jcs_C_trans', 'jcs_O_rev', 'rbs_connecting', 'rbs_crank', 'rbs_ground', 'rbs_slider'])
...
vel_rhs_s=pd.Series([8 *[None]],index=['jcs_A_sph', 'jcs_B_uni', 'jcs_C_trans', 'jcs_O_rev', 'rbs_connecting', 'rbs_crank', 'rbs_ground', 'rbs_slider'])
def vel_rhs(actuators): 
	 vrhs=np.zeros((27,1))
	 return vrhs 
acc_rhs_s=pd.Series([8 *[None]],index=['jcs_A_sph', 'jcs_B_uni', 'jcs_C_trans', 'jcs_O_rev', 'rbs_connecting', 'rbs_crank', 'rbs_ground', 'rbs_slider'])
