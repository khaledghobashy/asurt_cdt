...
jac_df=pd.DataFrame([15 *[None]],columns=['rbl_lca', 'rbl_strut_lower', 'rbl_strut_upper', 'rbl_tie', 'rbl_uca', 'rbl_upright', 'rbl_wheel_hub', 'rbr_lca', 'rbr_strut_lower', 'rbr_strut_upper', 'rbr_tie', 'rbr_uca', 'rbr_upright', 'rbr_wheel_hub', 'rbs_chassis'],index=['jcl_hub_bearing', 'jcl_lca_rev', 'jcl_lca_upright', 'jcl_strut_ch', 'jcl_strut_cyl', 'jcl_strut_lca', 'jcl_tie_ch', 'jcl_tie_upright', 'jcl_uca_rev', 'jcl_uca_upright', 'jcr_hub_bearing', 'jcr_lca_rev', 'jcr_lca_upright', 'jcr_strut_ch', 'jcr_strut_cyl', 'jcr_strut_lca', 'jcr_tie_ch', 'jcr_tie_upright', 'jcr_uca_rev', 'jcr_uca_upright', 'rbl_lca', 'rbl_strut_lower', 'rbl_strut_upper', 'rbl_tie', 'rbl_uca', 'rbl_upright', 'rbl_wheel_hub', 'rbr_lca', 'rbr_strut_lower', 'rbr_strut_upper', 'rbr_tie', 'rbr_uca', 'rbr_upright', 'rbr_wheel_hub', 'rbs_chassis', 'mcl_rotational_lock', 'mcr_rotational_lock', 'mcl_vertical', 'mcr_vertical'])
def cq(q,bodies,joints,actuators): 
	 ...
	 jac_df.loc['jcl_tie_ch','rbl_tie']=joints['jcl_tie_ch'].jacobian_i(q)
	 jac_df.loc['jcl_tie_ch','rbs_chassis']=joints['jcl_tie_ch'].jacobian_j(q)
	 jac_df.loc['jcl_tie_upright','rbl_tie']=joints['jcl_tie_upright'].jacobian_i(q)
	 ...
	 jac_df.loc['jcr_tie_ch','rbr_tie']=joints['jcr_tie_ch'].jacobian_i(q)
	 jac_df.loc['jcr_tie_ch','rbs_chassis']=joints['jcr_tie_ch'].jacobian_j(q)
	 jac_df.loc['jcr_tie_upright','rbr_tie']=joints['jcr_tie_upright'].jacobian_i(q)
	 ...
	 jac_df.loc['rbl_tie','rbl_tie']=bodies['rbl_tie'].unity_jacobian(q)
	 ...
	 jac_df.loc['rbr_tie','rbr_tie']=bodies['rbr_tie'].unity_jacobian(q)
...
eq_s=pd.Series([39 *[None]],index=['jcl_hub_bearing', 'jcl_lca_rev', 'jcl_lca_upright', 'jcl_strut_ch', 'jcl_strut_cyl', 'jcl_strut_lca', 'jcl_tie_ch', 'jcl_tie_upright', 'jcl_uca_rev', 'jcl_uca_upright', 'jcr_hub_bearing', 'jcr_lca_rev', 'jcr_lca_upright', 'jcr_strut_ch', 'jcr_strut_cyl', 'jcr_strut_lca', 'jcr_tie_ch', 'jcr_tie_upright', 'jcr_uca_rev', 'jcr_uca_upright', 'rbl_lca', 'rbl_strut_lower', 'rbl_strut_upper', 'rbl_tie', 'rbl_uca', 'rbl_upright', 'rbl_wheel_hub', 'rbr_lca', 'rbr_strut_lower', 'rbr_strut_upper', 'rbr_tie', 'rbr_uca', 'rbr_upright', 'rbr_wheel_hub', 'rbs_chassis', 'mcl_rotational_lock', 'mcr_rotational_lock', 'mcl_vertical', 'mcr_vertical'])
def eq(q,bodies,joints,actuators): 
	 ...
	 eq_s['rbl_tie']=bodies['rbl_tie'].unity_equation(q)
	 ...
	 eq_s['rbr_tie']=bodies['rbr_tie'].unity_equation(q)
...
vel_rhs_s=pd.Series([39 *[None]],index=['jcl_hub_bearing', 'jcl_lca_rev', 'jcl_lca_upright', 'jcl_strut_ch', 'jcl_strut_cyl', 'jcl_strut_lca', 'jcl_tie_ch', 'jcl_tie_upright', 'jcl_uca_rev', 'jcl_uca_upright', 'jcr_hub_bearing', 'jcr_lca_rev', 'jcr_lca_upright', 'jcr_strut_ch', 'jcr_strut_cyl', 'jcr_strut_lca', 'jcr_tie_ch', 'jcr_tie_upright', 'jcr_uca_rev', 'jcr_uca_upright', 'rbl_lca', 'rbl_strut_lower', 'rbl_strut_upper', 'rbl_tie', 'rbl_uca', 'rbl_upright', 'rbl_wheel_hub', 'rbr_lca', 'rbr_strut_lower', 'rbr_strut_upper', 'rbr_tie', 'rbr_uca', 'rbr_upright', 'rbr_wheel_hub', 'rbs_chassis', 'mcl_rotational_lock', 'mcr_rotational_lock', 'mcl_vertical', 'mcr_vertical'])
def vel_rhs(actuators): 
	 ...
	 return vrhs 
acc_rhs_s=pd.Series([39 *[None]],index=['jcl_hub_bearing', 'jcl_lca_rev', 'jcl_lca_upright', 'jcl_strut_ch', 'jcl_strut_cyl', 'jcl_strut_lca', 'jcl_tie_ch', 'jcl_tie_upright', 'jcl_uca_rev', 'jcl_uca_upright', 'jcr_hub_bearing', 'jcr_lca_rev', 'jcr_lca_upright', 'jcr_strut_ch', 'jcr_strut_cyl', 'jcr_strut_lca', 'jcr_tie_ch', 'jcr_tie_upright', 'jcr_uca_rev', 'jcr_uca_upright', 'rbl_lca', 'rbl_strut_lower', 'rbl_strut_upper', 'rbl_tie', 'rbl_uca', 'rbl_upright', 'rbl_wheel_hub', 'rbr_lca', 'rbr_strut_lower', 'rbr_strut_upper', 'rbr_tie', 'rbr_uca', 'rbr_upright', 'rbr_wheel_hub', 'rbs_chassis', 'mcl_rotational_lock', 'mcr_rotational_lock', 'mcl_vertical', 'mcr_vertical'])
def acc_rhs(q,qdot,bodies,joints,actuators): 
	 ...
	 acc_rhs_s['rbl_tie']=bodies['rbl_tie'].acc_rhs(qdot)
	 ...
	 acc_rhs_s['rbr_tie']=bodies['rbr_tie'].acc_rhs(qdot)
...
mass_matrix_df=pd.DataFrame([15 *[None]],columns=['rbl_lca', 'rbl_strut_lower', 'rbl_strut_upper', 'rbl_tie', 'rbl_uca', 'rbl_upright', 'rbl_wheel_hub', 'rbr_lca', 'rbr_strut_lower', 'rbr_strut_upper', 'rbr_tie', 'rbr_uca', 'rbr_upright', 'rbr_wheel_hub', 'rbs_chassis'],index=['rbl_lca', 'rbl_strut_lower', 'rbl_strut_upper', 'rbl_tie', 'rbl_uca', 'rbl_upright', 'rbl_wheel_hub', 'rbr_lca', 'rbr_strut_lower', 'rbr_strut_upper', 'rbr_tie', 'rbr_uca', 'rbr_upright', 'rbr_wheel_hub', 'rbs_chassis'])
def mass_matrix(q,bodies): 
	 ...
	 mass_matrix_df.loc['rbl_tie','rbl_tie']=bodies['rbl_tie'].mass_matrix(q)
	 ...
	 mass_matrix_df.loc['rbr_tie','rbr_tie']=bodies['rbr_tie'].mass_matrix(q)
...
Qg_s=pd.Series([15 *np.zeros((7,1))],index=['rbl_lca', 'rbl_strut_lower', 'rbl_strut_upper', 'rbl_tie', 'rbl_uca', 'rbl_upright', 'rbl_wheel_hub', 'rbr_lca', 'rbr_strut_lower', 'rbr_strut_upper', 'rbr_tie', 'rbr_uca', 'rbr_upright', 'rbr_wheel_hub', 'rbs_chassis'])
def Qg(bodies): 
	 ...
	 Qg_s['rbl_tie']=bodies['rbl_tie'].gravity()
	 ...
	 Qg_s['rbr_tie']=bodies['rbr_tie'].gravity()
...
Qv_s=pd.Series([15 *np.zeros((7,1))],index=['rbl_lca', 'rbl_strut_lower', 'rbl_strut_upper', 'rbl_tie', 'rbl_uca', 'rbl_upright', 'rbl_wheel_hub', 'rbr_lca', 'rbr_strut_lower', 'rbr_strut_upper', 'rbr_tie', 'rbr_uca', 'rbr_upright', 'rbr_wheel_hub', 'rbs_chassis'])
def Qv(bodies,q,qdot): 
	 ...
	 Qv_s['rbl_tie']=bodies['rbl_tie'].centrifugal(q,qdot)
	 ...
	 Qv_s['rbr_tie']=bodies['rbr_tie'].centrifugal(q,qdot)
...
Qa_s=pd.Series([15 *np.zeros((7,1))],index=['rbl_lca', 'rbl_strut_lower', 'rbl_strut_upper', 'rbl_tie', 'rbl_uca', 'rbl_upright', 'rbl_wheel_hub', 'rbr_lca', 'rbr_strut_lower', 'rbr_strut_upper', 'rbr_tie', 'rbr_uca', 'rbr_upright', 'rbr_wheel_hub', 'rbs_chassis'])
