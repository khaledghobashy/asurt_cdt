...
jac_df=pd.DataFrame([40 *[None]],columns=['chassis', 'ground', 'uca_rr', 'lca_rr', 'upright_rr', 'tie_rr', 'd1_rr', 'd2_rr', 'wheel_rr', 'uca_lr', 'lca_lr', 'upright_lr', 'tie_lr', 'd1_lr', 'd2_lr', 'wheel_lr', 'uca_rf', 'lca_rf', 'upright_rf', 'tie_rf', 'd1_rf', 'd2_rf', 'wheel_rf', 'uca_lf', 'lca_lf', 'upright_lf', 'tie_lf', 'd1_lf', 'd2_lf', 'wheel_lf', 'l1_rear', 'l2_rear', 'l3_rear', 'l4_rear', 'l5_rear', 'l1_front', 'l2_front', 'l3_front', 'l4_front', 'l5_front'],index=['ucaf_lf_rev', 'lcaf_lf_rev', 'ucao_lf_sph', 'lcao_lf_sph', 'tro_lf_sph', 'ch_sh_lf_uni', 'sh_lca_lf_uni', 'tri_lf_uni', 'd_m_lf_cyl', 'wc_lf_rev', 'ucaf_rr_rev', 'lcaf_rr_rev', 'ucao_rr_sph', 'lcao_rr_sph', 'tro_rr_sph', 'ch_sh_rr_uni', 'sh_lca_rr_uni', 'tri_rr_uni', 'd_m_rr_cyl', 'wc_rr_rev', 'ucaf_rf_rev', 'lcaf_rf_rev', 'ucao_rf_sph', 'lcao_rf_sph', 'tro_rf_sph', 'ch_sh_rf_uni', 'sh_lca_rf_uni', 'tri_rf_uni', 'd_m_rf_cyl', 'wc_rf_rev', 'ucaf_lr_rev', 'lcaf_lr_rev', 'ucao_lr_sph', 'lcao_lr_sph', 'tro_lr_sph', 'ch_sh_lr_uni', 'sh_lca_lr_uni', 'tri_lr_uni', 'd_m_lr_cyl', 'wc_lr_rev', 'mount_1_front_rev', 'mount_2_front_rev', 'C1_front_uni', 'E_front_uni', 'F_front_uni', 'C2_front_sph', 'EF_front_cyl', 'mount_1_rear_rev', 'mount_2_rear_rev', 'C1_rear_uni', 'E_rear_uni', 'F_rear_uni', 'C2_rear_sph', 'EF_rear_cyl', 'chassis', 'ground', 'uca_rr', 'lca_rr', 'upright_rr', 'tie_rr', 'd1_rr', 'd2_rr', 'wheel_rr', 'uca_lr', 'lca_lr', 'upright_lr', 'tie_lr', 'd1_lr', 'd2_lr', 'wheel_lr', 'uca_rf', 'lca_rf', 'upright_rf', 'tie_rf', 'd1_rf', 'd2_rf', 'wheel_rf', 'uca_lf', 'lca_lf', 'upright_lf', 'tie_lf', 'd1_lf', 'd2_lf', 'wheel_lf', 'l1_rear', 'l2_rear', 'l3_rear', 'l4_rear', 'l5_rear', 'l1_front', 'l2_front', 'l3_front', 'l4_front', 'l5_front', 'wc_lf_rev_actuator', 'wc_rf_rev_actuator', 'wc_lr_rev_actuator', 'wc_rr_rev_actuator', 'l5_rear.y_actuator', 'l5_front.y_actuator'])
def cq(q,bodies,joints,actuators): 
	 ...
	 jac_df.loc['tri_lf_uni','l3_front']=joints['tri_lf_uni'].jacobian_i(q)
	 ...
	 jac_df.loc['tri_rf_uni','l1_front']=joints['tri_rf_uni'].jacobian_i(q)
	 ...
	 jac_df.loc['mount_1_front_rev','l1_front']=joints['mount_1_front_rev'].jacobian_i(q)
	 jac_df.loc['mount_1_front_rev','chassis']=joints['mount_1_front_rev'].jacobian_j(q)
	 jac_df.loc['mount_2_front_rev','l3_front']=joints['mount_2_front_rev'].jacobian_i(q)
	 jac_df.loc['mount_2_front_rev','chassis']=joints['mount_2_front_rev'].jacobian_j(q)
	 jac_df.loc['C1_front_uni','l1_front']=joints['C1_front_uni'].jacobian_i(q)
	 jac_df.loc['C1_front_uni','l2_front']=joints['C1_front_uni'].jacobian_j(q)
	 jac_df.loc['E_front_uni','l4_front']=joints['E_front_uni'].jacobian_i(q)
	 jac_df.loc['E_front_uni','chassis']=joints['E_front_uni'].jacobian_j(q)
	 jac_df.loc['F_front_uni','l5_front']=joints['F_front_uni'].jacobian_i(q)
	 jac_df.loc['F_front_uni','l3_front']=joints['F_front_uni'].jacobian_j(q)
	 jac_df.loc['C2_front_sph','l2_front']=joints['C2_front_sph'].jacobian_i(q)
	 jac_df.loc['C2_front_sph','l3_front']=joints['C2_front_sph'].jacobian_j(q)
	 jac_df.loc['EF_front_cyl','l4_front']=joints['EF_front_cyl'].jacobian_i(q)
	 jac_df.loc['EF_front_cyl','l5_front']=joints['EF_front_cyl'].jacobian_j(q)
	 ...
	 jac_df.loc['l1_front','l1_front']=bodies['l1_front'].unity_jacobian(q)
	 jac_df.loc['l2_front','l2_front']=bodies['l2_front'].unity_jacobian(q)
	 jac_df.loc['l3_front','l3_front']=bodies['l3_front'].unity_jacobian(q)
	 jac_df.loc['l4_front','l4_front']=bodies['l4_front'].unity_jacobian(q)
	 jac_df.loc['l5_front','l5_front']=bodies['l5_front'].unity_jacobian(q)
	 ...
	 jac_df.loc['l5_front.y_actuator','l5_front']=actuators['l5_front.y_actuator'].jacobian()
	 jac=sparse.bmat(jac_df,format='csc') 
	 return jac 


eq_s=pd.Series([100 *[None]],index=['ucaf_lf_rev', 'lcaf_lf_rev', 'ucao_lf_sph', 'lcao_lf_sph', 'tro_lf_sph', 'ch_sh_lf_uni', 'sh_lca_lf_uni', 'tri_lf_uni', 'd_m_lf_cyl', 'wc_lf_rev', 'ucaf_rr_rev', 'lcaf_rr_rev', 'ucao_rr_sph', 'lcao_rr_sph', 'tro_rr_sph', 'ch_sh_rr_uni', 'sh_lca_rr_uni', 'tri_rr_uni', 'd_m_rr_cyl', 'wc_rr_rev', 'ucaf_rf_rev', 'lcaf_rf_rev', 'ucao_rf_sph', 'lcao_rf_sph', 'tro_rf_sph', 'ch_sh_rf_uni', 'sh_lca_rf_uni', 'tri_rf_uni', 'd_m_rf_cyl', 'wc_rf_rev', 'ucaf_lr_rev', 'lcaf_lr_rev', 'ucao_lr_sph', 'lcao_lr_sph', 'tro_lr_sph', 'ch_sh_lr_uni', 'sh_lca_lr_uni', 'tri_lr_uni', 'd_m_lr_cyl', 'wc_lr_rev', 'mount_1_front_rev', 'mount_2_front_rev', 'C1_front_uni', 'E_front_uni', 'F_front_uni', 'C2_front_sph', 'EF_front_cyl', 'mount_1_rear_rev', 'mount_2_rear_rev', 'C1_rear_uni', 'E_rear_uni', 'F_rear_uni', 'C2_rear_sph', 'EF_rear_cyl', 'chassis', 'ground', 'uca_rr', 'lca_rr', 'upright_rr', 'tie_rr', 'd1_rr', 'd2_rr', 'wheel_rr', 'uca_lr', 'lca_lr', 'upright_lr', 'tie_lr', 'd1_lr', 'd2_lr', 'wheel_lr', 'uca_rf', 'lca_rf', 'upright_rf', 'tie_rf', 'd1_rf', 'd2_rf', 'wheel_rf', 'uca_lf', 'lca_lf', 'upright_lf', 'tie_lf', 'd1_lf', 'd2_lf', 'wheel_lf', 'l1_rear', 'l2_rear', 'l3_rear', 'l4_rear', 'l5_rear', 'l1_front', 'l2_front', 'l3_front', 'l4_front', 'l5_front', 'wc_lf_rev_actuator', 'wc_rf_rev_actuator', 'wc_lr_rev_actuator', 'wc_rr_rev_actuator', 'l5_rear.y_actuator', 'l5_front.y_actuator'])
def eq(q,bodies,joints,actuators): 
	 ...
	 eq_s['mount_1_front_rev']=joints['mount_1_front_rev'].equations(q)
	 eq_s['mount_2_front_rev']=joints['mount_2_front_rev'].equations(q)
	 eq_s['C1_front_uni']=joints['C1_front_uni'].equations(q)
	 eq_s['E_front_uni']=joints['E_front_uni'].equations(q)
	 eq_s['F_front_uni']=joints['F_front_uni'].equations(q)
	 eq_s['C2_front_sph']=joints['C2_front_sph'].equations(q)
	 eq_s['EF_front_cyl']=joints['EF_front_cyl'].equations(q)
	 ...
	 eq_s['l1_front']=bodies['l1_front'].unity_equation(q)
	 eq_s['l2_front']=bodies['l2_front'].unity_equation(q)
	 eq_s['l3_front']=bodies['l3_front'].unity_equation(q)
	 eq_s['l4_front']=bodies['l4_front'].unity_equation(q)
	 eq_s['l5_front']=bodies['l5_front'].unity_equation(q)
	 ...
	 eq_s['l5_front.y_actuator']=actuators['l5_front.y_actuator'].equations(q)
	 system=sparse.bmat(eq_s.values.reshape((100,1)),format='csc') 
	 return system.A.reshape((270,)) 


vel_rhs_s=pd.Series([100 *[None]],index=['ucaf_lf_rev', 'lcaf_lf_rev', 'ucao_lf_sph', 'lcao_lf_sph', 'tro_lf_sph', 'ch_sh_lf_uni', 'sh_lca_lf_uni', 'tri_lf_uni', 'd_m_lf_cyl', 'wc_lf_rev', 'ucaf_rr_rev', 'lcaf_rr_rev', 'ucao_rr_sph', 'lcao_rr_sph', 'tro_rr_sph', 'ch_sh_rr_uni', 'sh_lca_rr_uni', 'tri_rr_uni', 'd_m_rr_cyl', 'wc_rr_rev', 'ucaf_rf_rev', 'lcaf_rf_rev', 'ucao_rf_sph', 'lcao_rf_sph', 'tro_rf_sph', 'ch_sh_rf_uni', 'sh_lca_rf_uni', 'tri_rf_uni', 'd_m_rf_cyl', 'wc_rf_rev', 'ucaf_lr_rev', 'lcaf_lr_rev', 'ucao_lr_sph', 'lcao_lr_sph', 'tro_lr_sph', 'ch_sh_lr_uni', 'sh_lca_lr_uni', 'tri_lr_uni', 'd_m_lr_cyl', 'wc_lr_rev', 'mount_1_front_rev', 'mount_2_front_rev', 'C1_front_uni', 'E_front_uni', 'F_front_uni', 'C2_front_sph', 'EF_front_cyl', 'mount_1_rear_rev', 'mount_2_rear_rev', 'C1_rear_uni', 'E_rear_uni', 'F_rear_uni', 'C2_rear_sph', 'EF_rear_cyl', 'chassis', 'ground', 'uca_rr', 'lca_rr', 'upright_rr', 'tie_rr', 'd1_rr', 'd2_rr', 'wheel_rr', 'uca_lr', 'lca_lr', 'upright_lr', 'tie_lr', 'd1_lr', 'd2_lr', 'wheel_lr', 'uca_rf', 'lca_rf', 'upright_rf', 'tie_rf', 'd1_rf', 'd2_rf', 'wheel_rf', 'uca_lf', 'lca_lf', 'upright_lf', 'tie_lf', 'd1_lf', 'd2_lf', 'wheel_lf', 'l1_rear', 'l2_rear', 'l3_rear', 'l4_rear', 'l5_rear', 'l1_front', 'l2_front', 'l3_front', 'l4_front', 'l5_front', 'wc_lf_rev_actuator', 'wc_rf_rev_actuator', 'wc_lr_rev_actuator', 'wc_rr_rev_actuator', 'l5_rear.y_actuator', 'l5_front.y_actuator'])
def vel_rhs(actuators): 
	 ...
	 vrhs=np.concatenate([vrhs,actuators['l5_front.y_actuator'].vel_rhs()]) 
	 return vrhs 
acc_rhs_s=pd.Series([100 *[None]],index=['ucaf_lf_rev', 'lcaf_lf_rev', 'ucao_lf_sph', 'lcao_lf_sph', 'tro_lf_sph', 'ch_sh_lf_uni', 'sh_lca_lf_uni', 'tri_lf_uni', 'd_m_lf_cyl', 'wc_lf_rev', 'ucaf_rr_rev', 'lcaf_rr_rev', 'ucao_rr_sph', 'lcao_rr_sph', 'tro_rr_sph', 'ch_sh_rr_uni', 'sh_lca_rr_uni', 'tri_rr_uni', 'd_m_rr_cyl', 'wc_rr_rev', 'ucaf_rf_rev', 'lcaf_rf_rev', 'ucao_rf_sph', 'lcao_rf_sph', 'tro_rf_sph', 'ch_sh_rf_uni', 'sh_lca_rf_uni', 'tri_rf_uni', 'd_m_rf_cyl', 'wc_rf_rev', 'ucaf_lr_rev', 'lcaf_lr_rev', 'ucao_lr_sph', 'lcao_lr_sph', 'tro_lr_sph', 'ch_sh_lr_uni', 'sh_lca_lr_uni', 'tri_lr_uni', 'd_m_lr_cyl', 'wc_lr_rev', 'mount_1_front_rev', 'mount_2_front_rev', 'C1_front_uni', 'E_front_uni', 'F_front_uni', 'C2_front_sph', 'EF_front_cyl', 'mount_1_rear_rev', 'mount_2_rear_rev', 'C1_rear_uni', 'E_rear_uni', 'F_rear_uni', 'C2_rear_sph', 'EF_rear_cyl', 'chassis', 'ground', 'uca_rr', 'lca_rr', 'upright_rr', 'tie_rr', 'd1_rr', 'd2_rr', 'wheel_rr', 'uca_lr', 'lca_lr', 'upright_lr', 'tie_lr', 'd1_lr', 'd2_lr', 'wheel_lr', 'uca_rf', 'lca_rf', 'upright_rf', 'tie_rf', 'd1_rf', 'd2_rf', 'wheel_rf', 'uca_lf', 'lca_lf', 'upright_lf', 'tie_lf', 'd1_lf', 'd2_lf', 'wheel_lf', 'l1_rear', 'l2_rear', 'l3_rear', 'l4_rear', 'l5_rear', 'l1_front', 'l2_front', 'l3_front', 'l4_front', 'l5_front', 'wc_lf_rev_actuator', 'wc_rf_rev_actuator', 'wc_lr_rev_actuator', 'wc_rr_rev_actuator', 'l5_rear.y_actuator', 'l5_front.y_actuator'])
def acc_rhs(q,qdot,bodies,joints,actuators): 
	 ...
	 acc_rhs_s['mount_1_front_rev']=joints['mount_1_front_rev'].acc_rhs(q,qdot)
	 acc_rhs_s['mount_2_front_rev']=joints['mount_2_front_rev'].acc_rhs(q,qdot)
	 acc_rhs_s['C1_front_uni']=joints['C1_front_uni'].acc_rhs(q,qdot)
	 acc_rhs_s['E_front_uni']=joints['E_front_uni'].acc_rhs(q,qdot)
	 acc_rhs_s['F_front_uni']=joints['F_front_uni'].acc_rhs(q,qdot)
	 acc_rhs_s['C2_front_sph']=joints['C2_front_sph'].acc_rhs(q,qdot)
	 acc_rhs_s['EF_front_cyl']=joints['EF_front_cyl'].acc_rhs(q,qdot)
	 ...
	 acc_rhs_s['l1_front']=bodies['l1_front'].acc_rhs(qdot)
	 acc_rhs_s['l2_front']=bodies['l2_front'].acc_rhs(qdot)
	 acc_rhs_s['l3_front']=bodies['l3_front'].acc_rhs(qdot)
	 acc_rhs_s['l4_front']=bodies['l4_front'].acc_rhs(qdot)
	 acc_rhs_s['l5_front']=bodies['l5_front'].acc_rhs(qdot)
	 ...
	 acc_rhs_s['l5_front.y_actuator']=actuators['l5_front.y_actuator'].acc_rhs(q,qdot)
	 system=sparse.bmat(acc_rhs_s.values.reshape((100,1)),format='csc') 
	 return system.A.reshape((270,)) 


mass_matrix_df=pd.DataFrame([40 *[None]],columns=['chassis', 'ground', 'uca_rr', 'lca_rr', 'upright_rr', 'tie_rr', 'd1_rr', 'd2_rr', 'wheel_rr', 'uca_lr', 'lca_lr', 'upright_lr', 'tie_lr', 'd1_lr', 'd2_lr', 'wheel_lr', 'uca_rf', 'lca_rf', 'upright_rf', 'tie_rf', 'd1_rf', 'd2_rf', 'wheel_rf', 'uca_lf', 'lca_lf', 'upright_lf', 'tie_lf', 'd1_lf', 'd2_lf', 'wheel_lf', 'l1_rear', 'l2_rear', 'l3_rear', 'l4_rear', 'l5_rear', 'l1_front', 'l2_front', 'l3_front', 'l4_front', 'l5_front'],index=['chassis', 'ground', 'uca_rr', 'lca_rr', 'upright_rr', 'tie_rr', 'd1_rr', 'd2_rr', 'wheel_rr', 'uca_lr', 'lca_lr', 'upright_lr', 'tie_lr', 'd1_lr', 'd2_lr', 'wheel_lr', 'uca_rf', 'lca_rf', 'upright_rf', 'tie_rf', 'd1_rf', 'd2_rf', 'wheel_rf', 'uca_lf', 'lca_lf', 'upright_lf', 'tie_lf', 'd1_lf', 'd2_lf', 'wheel_lf', 'l1_rear', 'l2_rear', 'l3_rear', 'l4_rear', 'l5_rear', 'l1_front', 'l2_front', 'l3_front', 'l4_front', 'l5_front'])
def mass_matrix(q,bodies): 
	 ...
	 mass_matrix_df.loc['l1_front','l1_front']=bodies['l1_front'].mass_matrix(q)
	 mass_matrix_df.loc['l2_front','l2_front']=bodies['l2_front'].mass_matrix(q)
	 mass_matrix_df.loc['l3_front','l3_front']=bodies['l3_front'].mass_matrix(q)
	 mass_matrix_df.loc['l4_front','l4_front']=bodies['l4_front'].mass_matrix(q)
	 mass_matrix_df.loc['l5_front','l5_front']=bodies['l5_front'].mass_matrix(q)
	 mass_matrix=sparse.bmat(mass_matrix_df,format='csc') 
	 return mass_matrix 


Qg_s=pd.Series([40 *np.zeros((7,1))],index=['chassis', 'ground', 'uca_rr', 'lca_rr', 'upright_rr', 'tie_rr', 'd1_rr', 'd2_rr', 'wheel_rr', 'uca_lr', 'lca_lr', 'upright_lr', 'tie_lr', 'd1_lr', 'd2_lr', 'wheel_lr', 'uca_rf', 'lca_rf', 'upright_rf', 'tie_rf', 'd1_rf', 'd2_rf', 'wheel_rf', 'uca_lf', 'lca_lf', 'upright_lf', 'tie_lf', 'd1_lf', 'd2_lf', 'wheel_lf', 'l1_rear', 'l2_rear', 'l3_rear', 'l4_rear', 'l5_rear', 'l1_front', 'l2_front', 'l3_front', 'l4_front', 'l5_front'])
def Qg(bodies): 
	 ...
	 Qg_s['l1_front']=bodies['l1_front'].gravity()
	 Qg_s['l2_front']=bodies['l2_front'].gravity()
	 Qg_s['l3_front']=bodies['l3_front'].gravity()
	 Qg_s['l4_front']=bodies['l4_front'].gravity()
	 Qg_s['l5_front']=bodies['l5_front'].gravity()
	 system=sparse.bmat(Qg_s.values.reshape((40,1)),format='csc') 
	 return system.A.reshape((280,)) 


Qv_s=pd.Series([40 *np.zeros((7,1))],index=['chassis', 'ground', 'uca_rr', 'lca_rr', 'upright_rr', 'tie_rr', 'd1_rr', 'd2_rr', 'wheel_rr', 'uca_lr', 'lca_lr', 'upright_lr', 'tie_lr', 'd1_lr', 'd2_lr', 'wheel_lr', 'uca_rf', 'lca_rf', 'upright_rf', 'tie_rf', 'd1_rf', 'd2_rf', 'wheel_rf', 'uca_lf', 'lca_lf', 'upright_lf', 'tie_lf', 'd1_lf', 'd2_lf', 'wheel_lf', 'l1_rear', 'l2_rear', 'l3_rear', 'l4_rear', 'l5_rear', 'l1_front', 'l2_front', 'l3_front', 'l4_front', 'l5_front'])
def Qv(bodies,q,qdot): 
	 ...
	 Qv_s['l1_front']=bodies['l1_front'].centrifugal(q,qdot)
	 Qv_s['l2_front']=bodies['l2_front'].centrifugal(q,qdot)
	 Qv_s['l3_front']=bodies['l3_front'].centrifugal(q,qdot)
	 Qv_s['l4_front']=bodies['l4_front'].centrifugal(q,qdot)
	 Qv_s['l5_front']=bodies['l5_front'].centrifugal(q,qdot)
	 system=sparse.bmat(Qv_s.values.reshape((40,1)),format='csc') 
	 return system.A.reshape((280,)) 


Qa_s=pd.Series([40 *np.zeros((7,1))],index=['chassis', 'ground', 'uca_rr', 'lca_rr', 'upright_rr', 'tie_rr', 'd1_rr', 'd2_rr', 'wheel_rr', 'uca_lr', 'lca_lr', 'upright_lr', 'tie_lr', 'd1_lr', 'd2_lr', 'wheel_lr', 'uca_rf', 'lca_rf', 'upright_rf', 'tie_rf', 'd1_rf', 'd2_rf', 'wheel_rf', 'uca_lf', 'lca_lf', 'upright_lf', 'tie_lf', 'd1_lf', 'd2_lf', 'wheel_lf', 'l1_rear', 'l2_rear', 'l3_rear', 'l4_rear', 'l5_rear', 'l1_front', 'l2_front', 'l3_front', 'l4_front', 'l5_front'])
...
def JR(joints,q,lamda): 
	 ...
	 JR_s[['mount_1_front_rev_Fx', 'mount_1_front_rev_Fy', 'mount_1_front_rev_Fz', 'mount_1_front_rev_Mx', 'mount_1_front_rev_My', 'mount_1_front_rev_Mz']]=joints['mount_1_front_rev'].reactions(q,lamda)
	 JR_s[['mount_2_front_rev_Fx', 'mount_2_front_rev_Fy', 'mount_2_front_rev_Fz', 'mount_2_front_rev_Mx', 'mount_2_front_rev_My', 'mount_2_front_rev_Mz']]=joints['mount_2_front_rev'].reactions(q,lamda)
	 JR_s[['C1_front_uni_Fx', 'C1_front_uni_Fy', 'C1_front_uni_Fz', 'C1_front_uni_Mx', 'C1_front_uni_My', 'C1_front_uni_Mz']]=joints['C1_front_uni'].reactions(q,lamda)
	 JR_s[['E_front_uni_Fx', 'E_front_uni_Fy', 'E_front_uni_Fz', 'E_front_uni_Mx', 'E_front_uni_My', 'E_front_uni_Mz']]=joints['E_front_uni'].reactions(q,lamda)
	 JR_s[['F_front_uni_Fx', 'F_front_uni_Fy', 'F_front_uni_Fz', 'F_front_uni_Mx', 'F_front_uni_My', 'F_front_uni_Mz']]=joints['F_front_uni'].reactions(q,lamda)
	 JR_s[['C2_front_sph_Fx', 'C2_front_sph_Fy', 'C2_front_sph_Fz', 'C2_front_sph_Mx', 'C2_front_sph_My', 'C2_front_sph_Mz']]=joints['C2_front_sph'].reactions(q,lamda)
	 JR_s[['EF_front_cyl_Fx', 'EF_front_cyl_Fy', 'EF_front_cyl_Fz', 'EF_front_cyl_Mx', 'EF_front_cyl_My', 'EF_front_cyl_Mz']]=joints['EF_front_cyl'].reactions(q,lamda)
