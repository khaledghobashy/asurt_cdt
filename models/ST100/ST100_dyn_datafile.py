...
jac_df=pd.DataFrame([21 *[None]],columns=['ground', 'chassis', 'uca', 'lca', 'upright', 'tie', 'd1', 'd2', 'wheel', 'uca_r', 'lca_r', 'upright_r', 'tie_r', 'd1_r', 'd2_r', 'wheel_r', 'l1', 'l2', 'l3', 'l4', 'l5'],index=['ucaf_rev', 'lcaf_rev', 'ucao_sph', 'lcao_sph', 'tro_sph', 'ch_sh_uni', 'sh_lca_uni', 'tri_uni', 'd_m_cyl', 'wc_rev', 'ucaf_r_rev', 'lcaf_r_rev', 'ucao_r_sph', 'lcao_r_sph', 'tro_r_sph', 'ch_sh_r_uni', 'sh_lca_r_uni', 'tri_r_uni', 'd_m_r_cyl', 'wc_r_rev', 'mount_1_rev', 'mount_2_rev', 'C1_uni', 'E_uni', 'F_uni', 'C2_sph', 'EF_cyl', 'origin_br', 'ground', 'chassis', 'uca', 'lca', 'upright', 'tie', 'd1', 'd2', 'wheel', 'uca_r', 'lca_r', 'upright_r', 'tie_r', 'd1_r', 'd2_r', 'wheel_r', 'l1', 'l2', 'l3', 'l4', 'l5', 'wc_rev_actuator', 'wc_r_rev_actuator', 'l5.y_actuator'])
...
eq_s=pd.Series([52 *[None]],index=['ucaf_rev', 'lcaf_rev', 'ucao_sph', 'lcao_sph', 'tro_sph', 'ch_sh_uni', 'sh_lca_uni', 'tri_uni', 'd_m_cyl', 'wc_rev', 'ucaf_r_rev', 'lcaf_r_rev', 'ucao_r_sph', 'lcao_r_sph', 'tro_r_sph', 'ch_sh_r_uni', 'sh_lca_r_uni', 'tri_r_uni', 'd_m_r_cyl', 'wc_r_rev', 'mount_1_rev', 'mount_2_rev', 'C1_uni', 'E_uni', 'F_uni', 'C2_sph', 'EF_cyl', 'origin_br', 'ground', 'chassis', 'uca', 'lca', 'upright', 'tie', 'd1', 'd2', 'wheel', 'uca_r', 'lca_r', 'upright_r', 'tie_r', 'd1_r', 'd2_r', 'wheel_r', 'l1', 'l2', 'l3', 'l4', 'l5', 'wc_rev_actuator', 'wc_r_rev_actuator', 'l5.y_actuator'])
...
vel_rhs_s=pd.Series([52 *[None]],index=['ucaf_rev', 'lcaf_rev', 'ucao_sph', 'lcao_sph', 'tro_sph', 'ch_sh_uni', 'sh_lca_uni', 'tri_uni', 'd_m_cyl', 'wc_rev', 'ucaf_r_rev', 'lcaf_r_rev', 'ucao_r_sph', 'lcao_r_sph', 'tro_r_sph', 'ch_sh_r_uni', 'sh_lca_r_uni', 'tri_r_uni', 'd_m_r_cyl', 'wc_r_rev', 'mount_1_rev', 'mount_2_rev', 'C1_uni', 'E_uni', 'F_uni', 'C2_sph', 'EF_cyl', 'origin_br', 'ground', 'chassis', 'uca', 'lca', 'upright', 'tie', 'd1', 'd2', 'wheel', 'uca_r', 'lca_r', 'upright_r', 'tie_r', 'd1_r', 'd2_r', 'wheel_r', 'l1', 'l2', 'l3', 'l4', 'l5', 'wc_rev_actuator', 'wc_r_rev_actuator', 'l5.y_actuator'])
def vel_rhs(actuators): 
	 ...
	 return vrhs 
acc_rhs_s=pd.Series([52 *[None]],index=['ucaf_rev', 'lcaf_rev', 'ucao_sph', 'lcao_sph', 'tro_sph', 'ch_sh_uni', 'sh_lca_uni', 'tri_uni', 'd_m_cyl', 'wc_rev', 'ucaf_r_rev', 'lcaf_r_rev', 'ucao_r_sph', 'lcao_r_sph', 'tro_r_sph', 'ch_sh_r_uni', 'sh_lca_r_uni', 'tri_r_uni', 'd_m_r_cyl', 'wc_r_rev', 'mount_1_rev', 'mount_2_rev', 'C1_uni', 'E_uni', 'F_uni', 'C2_sph', 'EF_cyl', 'origin_br', 'ground', 'chassis', 'uca', 'lca', 'upright', 'tie', 'd1', 'd2', 'wheel', 'uca_r', 'lca_r', 'upright_r', 'tie_r', 'd1_r', 'd2_r', 'wheel_r', 'l1', 'l2', 'l3', 'l4', 'l5', 'wc_rev_actuator', 'wc_r_rev_actuator', 'l5.y_actuator'])
...
def Qa(forces,q,qdot): 
	 ...
	 Qi,Qj=forces['gk_w11_r'].equation(q,qdot) 
	 Qa_s['d1_r']=Qi
	 Qa_s['d2_r']=Qj
