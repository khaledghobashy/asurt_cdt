...
jac_df=pd.DataFrame([10 *[None]],columns=['chassis', 'uca', 'lca', 'upright', 'push', 'tie', 'd1', 'd2', 'rocker', 'wheel'],index=['ucaf_rev', 'lcaf_rev', 'bcp_rev', 'ucao_sph', 'lcao_sph', 'uca_pr_sph', 'tro_sph', 'ch_sh_uni', 'bc_sh_uni', 'tri_uni', 'bc_pr_uni', 'd_m_cyl', 'wc_rev', 'chassis', 'uca', 'lca', 'upright', 'push', 'tie', 'd1', 'd2', 'rocker', 'wheel', 'wc_rev_actuator'])
...
eq_s=pd.Series([24 *[None]],index=['ucaf_rev', 'lcaf_rev', 'bcp_rev', 'ucao_sph', 'lcao_sph', 'uca_pr_sph', 'tro_sph', 'ch_sh_uni', 'bc_sh_uni', 'tri_uni', 'bc_pr_uni', 'd_m_cyl', 'wc_rev', 'chassis', 'uca', 'lca', 'upright', 'push', 'tie', 'd1', 'd2', 'rocker', 'wheel', 'wc_rev_actuator'])
def eq(q,bodies,joints,actuators): 
	 ...
	 system=sparse.bmat(eq_s.values.reshape((24,1)),format='csc') 
	 return system.A.reshape((69,)) 


vel_rhs_s=pd.Series([24 *[None]],index=['ucaf_rev', 'lcaf_rev', 'bcp_rev', 'ucao_sph', 'lcao_sph', 'uca_pr_sph', 'tro_sph', 'ch_sh_uni', 'bc_sh_uni', 'tri_uni', 'bc_pr_uni', 'd_m_cyl', 'wc_rev', 'chassis', 'uca', 'lca', 'upright', 'push', 'tie', 'd1', 'd2', 'rocker', 'wheel', 'wc_rev_actuator'])
def vel_rhs(actuators): 
	 vrhs=np.zeros((68,1))
	 vrhs=np.concatenate([vrhs,actuators['wc_rev_actuator'].vel_rhs()]) 
	 return vrhs 
acc_rhs_s=pd.Series([24 *[None]],index=['ucaf_rev', 'lcaf_rev', 'bcp_rev', 'ucao_sph', 'lcao_sph', 'uca_pr_sph', 'tro_sph', 'ch_sh_uni', 'bc_sh_uni', 'tri_uni', 'bc_pr_uni', 'd_m_cyl', 'wc_rev', 'chassis', 'uca', 'lca', 'upright', 'push', 'tie', 'd1', 'd2', 'rocker', 'wheel', 'wc_rev_actuator'])
def acc_rhs(q,qdot,bodies,joints,actuators): 
	 ...
	 system=sparse.bmat(acc_rhs_s.values.reshape((24,1)),format='csc') 
	 return system.A.reshape((69,)) 
