...
Qg_s=pd.Series([11 *np.zeros((7,1))],index=['ground', 'chassis', 'uca', 'lca', 'upright', 'push', 'tie', 'd1', 'd2', 'rocker', 'wheel'])
def Qg(bodies): 
